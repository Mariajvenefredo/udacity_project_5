...
class FakeDataSource(
    private val apiStoreItems: MutableList<StoreItemDTO> = emptyList<StoreItemDTO>().toMutableList(),
    private val apiStores: MutableList<PhysicalStoreDTO> = emptyList<PhysicalStoreDTO>().toMutableList(),
